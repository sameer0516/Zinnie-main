...
const OG_IMAGE = "https://zinniezeera.com/Zinnie-logo.png";
const TITLE = "Zinnie Soft Drinks – Refreshing & Affordable Cool Drinks in India";
const DESCRIPTION =
  "Discover Zinnie soft drinks – refreshing, affordable, and full of flavor. From Zeera Masala Soda to Mango & Lemon drinks, perfect for every moment.";
...
export const metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Zinnie Refreshing Soft Drinks Collection",
      },
    ],
  },
  ...
  twitter: {
    ...
    title: TITLE,
    description:
      "Enjoy Zinnie soft drinks – refreshing, affordable, and full of flavor. Try Zeera Masala Soda, Mango, Lemon & more. Perfect for every moment.",
    site: "@zinniezeera",
    creator: "@zinniezeera",
    images: [
      {
...
const organizationRatingSchema = {
  "@context": "https://schema.org",
  "@type": "Organization",
  "@id": "https://zinniezeera.com/#organization",
  name: "Zinnie",
...
export default function Page() {
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(organizationRatingSchema) }}
      />
      <script
        type="application/ld+json"
